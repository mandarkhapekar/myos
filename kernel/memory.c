...
/* Heap memory - we'll use a static array for now */
/* In a real OS, this would be at a fixed physical address */
static uint8_t heap_memory[HEAP_SIZE] __attribute__((aligned(BLOCK_ALIGN)));
